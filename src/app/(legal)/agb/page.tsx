...
export default function AgbPage() {
  return (
    <article className="prose dark:prose-invert max-w-3xl">
      ...
      <P>
        Um Ihr Widerrufsrecht auszuüben, müssen Sie uns (<strong>Patrick Hümmer Max Strobel GbR, Landsberger Straße 440a, 81241 München, info@estateably.de</strong>) mittels einer eindeutigen Erklärung (z. B. Brief oder E-Mail) über Ihren Entschluss informieren. Sie können das <a href="/muster-widerruf.pdf" className="text-accent hover:underline">beigefügte Muster-Widerrufsformular</a> verwenden. Zur Wahrung der Frist reicht die rechtzeitige Absendung.
      </P>
